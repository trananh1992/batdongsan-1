					...
					?>
							...
							<?php $form=$this->beginWidget('CActiveForm', array(
								...
								*/
								...
								<div class="clr"></div>
								<div >
									<?php echo CHtml::htmlButton($model->isNewRecord ? '<span class="glyphicon glyphicon-plus"></span> Đăng Tin' : '<span class="glyphicon glyphicon-remove"></span> Cancel', array('class' => 'btn btn-primary', 'type' => 'submit')); ?> &nbsp;  
