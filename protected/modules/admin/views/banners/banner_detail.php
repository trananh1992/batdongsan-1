<div class="panel panel-default">
	...
	if( !$model->isNewRecord)
    {
        ...
        <div class='form-group form-group-sm'>
			...
			<?php 
				$width = QuangCaoBanner::WIDTH1; 
				$height=QuangCaoBanner::HEIGHT1;
				if($model->id == 2) //top banner
				{
					$width = QuangCaoBanner::WIDTH2; 
					$height=QuangCaoBanner::HEIGHT2;
				}
			?>
		...
		<div class='form-group form-group-sm'>
			...
			<div class="col-sm-6">
				<?php 
				if(!empty($model->image) && $model->id==1 ) 
				{
					// echo $model->image;
					// echo ImageHelper::getImageUrl($model, 'image', TopBannerLeft::SIZE );
					echo '<img src="'.$model->getImageUrl('image', QuangCaoBanner::SIZE1 ).'" />';
					// echo ImageHelper::getImageUrl($model, 'image', '200x350' );
				}else if(!empty($model->image) && $model->id==2 ) 
				{
					echo '<img src="'.$model->getImageUrl('image', QuangCaoBanner::SIZE2 ).'" />';
				}	
              	?>
