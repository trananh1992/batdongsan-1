...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('tin-nha-dat-image-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('tin-nha-dat-image-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"tin-nha-dat-image-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('tin-nha-dat-image-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('tin-nha-dat-image-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#tin-nha-dat-image-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('tin-nha-dat-image-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php 
			...
			'id'=>'tin-nha-dat-image-grid-bulk',
