<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class='form-group form-group-sm'>
					<?php echo $form->labelEx($model,'tin_nha_dat_id', array('class' => 'col-sm-2 control-label')); ?>
					<div class="col-sm-6">
						<?php echo $form->textField($model,'tin_nha_dat_id', array('class' => 'form-control', 'maxlength' => 255)); ?>
						<?php echo $form->error($model,'tin_nha_dat_id'); ?>
					</div>
			</div>
    
			<div class='form-group form-group-sm'>
					<?php echo $form->labelEx($model,'updated_date', array('class' => 'col-sm-2 control-label')); ?>
					<div class="col-sm-6">
						<?php echo $form->textField($model,'updated_date', array('class' => 'ver_datepicker form-control', 'readonly' => 'true')); ?>
