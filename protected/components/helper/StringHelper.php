...
class StringHelper
{
    public static function getMenuTin($Tcontroller="",$Taction="", $mUser )
    {
        $class1="";
        $class2="";
        $class3="";
        $html ="";
        if($Tcontroller=="thanhvien" && $Taction=="index" )
        {
            $class1="active";
        }else if($Tcontroller=="thanhvien" && $Taction=="indexChuaDuyet" )
        {
            $class2="active";
        }else if($Tcontroller=="thanhvien" && $Taction=="indexKhongDuyet" )
        {
            $class3="active";
        }

        $html.='<span class="label label-success '.$class1.' "><a href="'.Yii::app()->createAbsoluteUrl('thanhvien/index').'" >Đã duyệt</a></span>
          <span class="label label-info '.$class2.' "><a href="'.Yii::app()->createAbsoluteUrl('thanhvien/indexChuaDuyet').'" >Chưa duyệt</a></span>
          <span class="label label-warning '.$class3.' "><a href="'.Yii::app()->createAbsoluteUrl('thanhvien/indexKhongDuyet').'" >Không duyệt</a></span>';
        return $html;
    }

    public static function getMenuThanhVien($Tcontroller="",$Taction="", $mUser )
    {
        $class1="";
        $class2="";
        $class3="";
        ...
        $class5="";
        $html ="";
        if($Tcontroller=="thanhvien" && ($Taction=="index" || $Taction=="indexChuaDuyet" || $Taction=="indexKhongDuyet"  ) )
        {
            $class1="active";
        }else if($Tcontroller=="site" && $Taction=="myProfile" )
        {
            $class2="active";
        }else if($Tcontroller=="site" && $Taction=="dangTin" )
        {
            $class3="active";
        }
        // else if($Tcontroller=="site" && $Taction=="myProfile" )
    ...
    //   </ul>
        ...
        $html.="<ul class='nav nav-pills nav-stacked'>";
            $html.="<li class='".$class1."'><a href='".Yii::app()->createAbsoluteUrl('thanhvien/index')."'>Tin Của Bạn</a></li>";
            $html.="<li ><a href='".Yii::app()->createAbsoluteUrl('thanhvien/indexChuaDuyet')."'>Tin Chờ Duyệt</a></li>";
            $html.="<li ><a href='".Yii::app()->createAbsoluteUrl('thanhvien/indexKhongDuyet')."'>Tin không duyệt</a></li>";
            $html.="<li class='".$class2."'><a href='".Yii::app()->createAbsoluteUrl('site/myProfile')."'>Tài Khoản Của Bạn</a></li>";
            $html.="<li class='".$class3."'><a href='".Yii::app()->createAbsoluteUrl('site/dangTin')."'>Đăng Tin</a></li>";
            $html.="<li class='".$class4."'><a href='".Yii::app()->createAbsoluteUrl('site/logout')."'>Đăng Xuất</a></li>";
            $html.="</ul>";
        return $html;
    }
