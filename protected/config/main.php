    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                'detail-page/<slug:[a-zA-Z0-9-]+>' => array('cms/index'),

                'tin-nha-dat/<parent_slug:[a-zA-Z0-9-]+>/<children_slug:[a-zA-Z0-9-]+>'=>'site/listTin',
                'tin-chi-tiet/<slug:[a-zA-Z0-9-]+>.html'=>'site/tinDetail',

                'tin-nha-dats-<TinNhaDat_page:[a-zA-Z0-9-]+>'=>'site/listTin',
                'tin-nha-dats'=>'site/listTin',
