...
class QuangCaoBanner extends _BaseModel {
	...
	public $uploadImageFolder = 'upload/bds2_banner'; //remember remove ending slash
	public $defineImageSize = array(
			'image' => array(
							array('alias' => self::SIZE1, 'size' => '260x400'),
							array('alias' => self::SIZE2, 'size' => '1138x200'),
	...
	public function rules()
	{
		return array(
			...
			array('image, title, name_banner', 'length', 'max'=>255),
		 	array('image', 'required', 'on' => 'create, update'), 
			...
			array('image,link', 'required', 'on' => 'veMayBay'), 
		);
	}
