...
class Users extends _BaseModel 
{
    ...
    public static $typeImage = 'jpg,gif,png';
    ...
    public function rules() {
        ...
        return array(
           ...
           array('username, email, password_hash, temp_password,','required','on'=>'NEED TO DEFINE SCENARIO ON BE'),
            array('temp_password,password_confirm,full_name, username', 'required', 'on' => 'createMemberFE'),
            array('full_name, username', 'required', 'on' => 'editAdmin'),
            ...
            array('username', 'match', 'pattern' => '/^[a-zA-Z\d_.]{2,30}$/i', 'message' => 'Username cannot include special characters', 'on' => 'createMemberFE,createAdmin, editAdmin'),
            // array('username, email, full_name', 'required', 'on' => 'createAdmin, editAdmin'),
            array('temp_password, password_confirm', 'required', 'on' => 'createAdmin, createMemberFE, UpdateAgentBE'),
            ...
            array('username', 'unique', 'message' => 'This email has already been taken.', 'on' => 'editAdmin, createAdmin, createMember, createMemberFE, CreateAgentBE'),
            ...
            array('username, full_name', 'required', 'on' => 'changeMyProfile'),
...
//               Yii::import('phpbb.models.*');
    ...
    public function attributeLabels() {
        return array(
            ...
            'password_confirm' => 'Lặp lại mật khẩu',
    ...
    public function search($criteria = NULL) {
        ...
        $criteria->addCondition('t.role_id ='.ROLE_MEMBER);
    ...
    public static function duyetTin($value)
    {
        if($value==DA_DUYET)
            return '<font color="blue">Đã Duyệt</font>';
        else if($value==CHUA_DUYET)
            return '<font color="red">Chưa Duyệt</font>';
        else if($value==KHONG_DUYET)
            return 'Không Duyệt';
    }
